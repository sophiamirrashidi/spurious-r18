...
def main(args):
    ...
    csv_path = f'{timestamp}_dropout{args.dropout_rate}_wb_probe_accuracy.csv'
    ...
    model = ResNetWithDropout(dropout_rate=args.dropout_rate)
    ...
    print("Saving model...")
    torch.save(model.state_dict(), f"./dropout{args.dropout_rate}_wb_resnet.pt")
